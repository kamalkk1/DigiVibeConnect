      ...
      <div className="relative container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center px-4 py-2 bg-muted rounded-full text-muted-foreground text-sm font-medium mb-6">
            ...
            <span data-testid="text-location">Serving Mohali • Chandigarh • Panchkula • Zirakpur</span>
          </div>
          
          <h1 className="font-poppins font-bold text-4xl md:text-6xl lg:text-7xl mb-6 leading-tight">
            <span className="gradient-text" data-testid="text-brand">DIGIVIBE</span><br/>
            <span data-testid="text-tagline-1">North India's Premier</span><br/>
            <span data-testid="text-tagline-2">Digital Growth Partner</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-3xl mx-auto leading-relaxed" data-testid="text-description">
            Helping Mohali, Chandigarh & Tricity businesses grow with SEO, social media, and performance-driven digital strategies.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-2xl mx-auto">
            <div className="glass rounded-2xl px-6 py-4 text-center">
              <div className="font-bold text-2xl text-primary mb-1" data-testid="stat-businesses">50+</div>
              <div className="text-sm text-muted-foreground" data-testid="stat-businesses-label">North India Businesses</div>
            </div>
            <div className="glass rounded-2xl px-6 py-4 text-center">
              <div className="font-bold text-2xl text-secondary mb-1" data-testid="stat-rating">★ 5.0</div>
              <div className="text-sm text-muted-foreground" data-testid="stat-rating-label">Google Partner Certified</div>
            </div>
            <div className="glass rounded-2xl px-6 py-4 text-center">
              <div className="font-bold text-2xl text-accent mb-1" data-testid="stat-roi">300%</div>
              <div className="text-sm text-muted-foreground" data-testid="stat-roi-label">Average ROI Increase</div>
            </div>
          </div>
        </div>
      </div>
